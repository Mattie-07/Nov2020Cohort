...
class Person:
    def __init__(self, firstName, lastName, email):
        ...
        self.email = email
        self.friends = [] # can you inistalize a friend from the parameter list
...
jordan = Person("Jordan" ,"Jman","jordan@hotmail.com" )
Claude = Person("Claude", "Cman", "Mike@hotmail.com")
Micah = Person("Micha", "Petterson", "MicePe@gmail.com")

jordan.add_friend(Claude)
jordan.add_friend(Micah)

print(jordan.firstName)

jordan.print_contact_info()

print(len(jordan.friends))

# jordan.friends.append(Claude)
# jordan.friends.append(Micah)
# print(Claude.friends)
# Claude.friends.append(jordan)
